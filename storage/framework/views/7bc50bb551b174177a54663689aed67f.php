<section id="testimoni" 
         ...
         x-data="{
             activeSlide: 0,
             totalSlides: <?php echo e(count($testimonials)); ?>,
             scrollToIndex(index) {
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-ref="sliderContainer"
            ...
            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="w-[85vw] max-w-[340px] sm:max-w-none md:w-auto shrink-0 snap-center bg-brand-cream/40 p-5 sm:p-7 rounded-modern border border-gray-200/70 shadow-sm hover:shadow-card transition-all duration-300 flex flex-col justify-between">
                <div>
                    ...
                    <div class="flex items-center justify-between mb-3.5">
                        <div class="flex text-amber-400 text-sm gap-0.5" aria-label="Rating 5 dari 5 bintang">
                ...
                <div class="pt-3.5 border-t border-gray-200/60 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] sm:text-[11px] text-gray-500 mt-0.5">
                            <?php echo e($rev['role']); ?> • <span class="text-gray-400"><?php echo e($rev['date']); ?></span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex md:hidden items-center justify-center gap-2 mt-4" aria-label="Navigasi Review Slider">
            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button @click="scrollToIndex(<?php echo e($idx); ?>)" 
                    type="button"
                    aria-label="Lihat ulasan <?php echo e($idx + 1); ?>"
                    class="h-1.5 rounded-full transition-all duration-300 focus:outline-none"
                    :class="activeSlide === <?php echo e($idx); ?> ? 'w-6 bg-brand-primary' : 'w-2 bg-gray-300 hover:bg-gray-400'"></button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

    </div>
</section>
<?php /**PATH C:\xampp\htdocs\sumberproteinjogja\resources\views/components/review-card.blade.php ENDPATH**/ ?>