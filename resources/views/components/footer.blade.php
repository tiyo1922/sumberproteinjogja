...
<footer class="bg-brand-dark text-white pt-16 pb-12 border-t border-brand-dark-soft">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-white/10">
            ...
            <div class="lg:col-span-2 space-y-4">
                <a href="#hero" class="flex items-center gap-3 group">
                    ...
                    <span class="text-xl font-extrabold tracking-tight text-white">
                        {{ $site['brand']['short_name'] ?? 'Sumber Protein' }} <span class="text-emerald-400">Jogja</span>
                    </span>
                </a>
                
                <p class="text-xs sm:text-sm text-gray-300 font-normal leading-relaxed max-w-sm">
                    {{ $site['brand']['description'] ?? 'Penyedia bahan makanan mentah, frozen food, dan olahan ready-to-cook berkualitas di Yogyakarta. Melayani kebutuhan konsumsi harian keluarga dan suplai horeka/curah.' }}
                </p>
            ...
            <div class="space-y-3">
                ...
                <div class="pt-1">
                    ...
                    <p class="text-xs text-white font-medium">{{ $location['operational_hours']['display'] ?? 'Senin – Minggu, 07.00 – 19.00 WIB' }}</p>
                </div>
                <div class="pt-1">
                    <p class="text-[11px] text-gray-400">Hotline Pemesanan:</p>
                    <p class="text-xs text-emerald-400 font-semibold">{{ $site['contact']['phone'] ?? '+62 812-3456-7890' }}</p>
                </div>
            </div>
        ...
        <div class="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 gap-4">
            <p>© {{ date('Y') }} {{ $site['website']['copyright'] ?? 'Sumber Protein Jogja. Hak Cipta Dilindungi.' }}</p>
